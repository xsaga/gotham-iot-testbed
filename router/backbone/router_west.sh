...
set interfaces ethernet eth0 address '192.168.16.1/20'
set interfaces ethernet eth1 address '10.0.0.0/31'
set interfaces ethernet eth2 address '10.0.0.4/31'
set interfaces loopback lo address '10.2.2.2/32'
set protocols ospf area 0 network '10.2.2.2/32'
set protocols ospf area 0 network '10.0.0.0/31'
set protocols ospf area 0 network '192.168.16.0/20'
